 ...
 * @author root
 */
@WebServlet(name = "ReportTransactionMarch", urlPatterns = {"/ReportTransactionMarch"})
public class ReportTransactionMarch extends HttpServlet {
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("StockOpPU");
    private List<RptStockTakeList> os = new ArrayList();
    /** 
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            os = this.findTransstockdetails(siteid,periodeid,from,to,variant,productinfo,marchcode);
    ...
    private List<RptStockTakeList> findTransstockdetails(String siteid,String periodeid,String from,String to,String variant,String productinfo,String marchcode){
        EntityManager em = this.getEntityManager();
        List<RptStockTakeList> os = new ArrayList();                        
        try{
            List<Transtockdetail> transtockdetails = this.findDetail(siteid, periodeid, from, to);
            System.out.println("Row Size : " + transtockdetails.size());
            for(Transtockdetail o : transtockdetails){
    ...
    private List<Transtockdetail> findDetail(String siteid,String periodeid,String from, String to){
        EntityManager em = this.getEntityManager();
        String strSQL = "SELECT t FROM Transtockdetail t WHERE t.transstock.site.siteid=:siteid AND t.transstock.periode.periodeid=:periodeid AND t.transstock.gondola.gondolaid between '" + siteid + from + "' AND '" + siteid + to + "' ORDER BY t.transstock.gondola.gondolaid, t.sequence";
        try{
