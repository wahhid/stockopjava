 ...
 * @author root
 */
@WebServlet(name = "ReportTransaction", urlPatterns = {"/ReportTransaction"}, initParams = {
    @WebInitParam(name = "gondolaid", value = "0"),
    @WebInitParam(name = "nik", value = "0")})
public class ReportTransaction extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            os = this.findTransstockdetails(siteid,periodeid,from,to,variant,productinfo);
            // fill it
    ...
    private List<RptStockTakeList> findTransstockdetails(String siteid,String periodeid,String from,String to,String variant,String productinfo){
        EntityManager em = this.getEntityManager();
        List<RptStockTakeList> os = new ArrayList();                        
        try{
